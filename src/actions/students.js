...
export function validateStudent(data) {
  ...
  if (!data.school_name || !data.school_name.trim()) errors.school_name = 'School is required.';
  if (!data.father_name || !data.father_name.trim()) errors.father_name = 'Father’s name is required.';
  if (!data.mother_name || !data.mother_name.trim()) errors.mother_name = 'Mother’s name is required.';
  ...
  if (!emergency || !isValidMobile(emergency)) errors.emergency_phone = 'An emergency number is required.';
